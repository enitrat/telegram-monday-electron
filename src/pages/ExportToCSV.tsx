  ...
  return (
    <Flex flexDir={'column'} alignItems={'center'} width={'100%'}>
      <Flex width={'50%'} flexDir={'column'}>
        <Heading alignSelf={'center'} justifySelf={'center'} as={'h1'} size={'md'} marginBottom={'5px'}>Select the group to export</Heading>
        {dialogs.length > 0 &&
        <Flex flexDir={'column'}>
            ...
            {suggestions.length > 0 && suggestions.map((suggestion) => {
              return (
                <Flex flexDir='column' justifyContent={'center'} key={suggestion.title} >
                  <Button width={'100%'} justifySelf='center' alignSelf={'center'} padding={'1px'} marginBottom='3px' variant={'unstyled'}
      ...
      <Flex>
        {selectedDialog && <Button marginTop={"50px"} onClick={startExport}>
          Download CSV
        </Button>
        }
      </Flex>
